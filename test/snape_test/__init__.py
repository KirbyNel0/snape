...
GLOBAL_VENV_ROOT: Final[Path] = TEST_DIR / "snape-global"
...
def _setup_snape():
    ...
    GLOBAL_VENV_ROOT.mkdir(parents=True, exist_ok=True)
    ...
    import snape
    snape.env_var.__VARS__["SNAPE_ROOT"] = str(GLOBAL_VENV_ROOT)
    snape.env_var.SNAPE_ROOT_PATH = GLOBAL_VENV_ROOT
