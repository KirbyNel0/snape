...
def is_global_snape_venv(env: VirtualEnv | Path) -> bool:
    """
    Check whether the specified environment path is located at the global snape venv directory.
